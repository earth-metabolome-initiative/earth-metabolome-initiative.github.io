...
about: Submit a request for new member to be added to Earth Metabolome Initiative.
labels: "new member"
title: "I'd like to join the Earth Metabolome Initiative"
assignees: "open-traits-network/editors"
---

Please update the template below and click "Submit" to let us know you'd like to become a member of the Earth Metabolome Initiative. Please allow for some time for @open-traits-network/editors to review your request.
